...
\section{本実習の目標}
\begin{itemize}
\item Processing と Arduino を接続し LED を制御する。
...
\section{Processing + Firmataをつかってみる: シリアルポートの確認}
...
Arduino.list()[5] の部分の数字 (5の部分) を先ほどメモした番号に変更してください。
...
\subsection{Processing + Firmataをつかってみる 1: Digital OUT \\UTF{2013} LEDを点灯}
