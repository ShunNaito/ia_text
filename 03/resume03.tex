...
\subsection*{プルアップ抵抗 → GND側に抵抗があり、ボタンを押すとLowになる。}
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.3\columnwidth]{img/pulldown.eps}
%  \caption{}
  \label{figure:LED}
\end{figure}
 
\subsection*{プルダウン抵抗 → 5V側に抵抗があり、ボタンを押すとHighになる。}
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.3\columnwidth]{img/pullup.eps}
%  \caption{}
  \label{figure:LED}
\end{figure}
